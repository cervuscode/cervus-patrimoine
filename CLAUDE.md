...
- **Lot 1 (À VENIR)** = lecture Pipedrive + vue client (Simulation vs Découverte RDV, jamais d'écrasement) + recherche par nom/code + génération code client (`C-0042`) + panneau persistant. Fenêtre Claude Code neuve.
