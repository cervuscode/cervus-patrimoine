...
application : iliad;
DATOCEANS12 = arr( (DATOCEANS/10000 - inf(DATOCEANS/10000))*10000 );
TXINR = max(0,NBMOISI * TXMOISRETARD) *positif(2017 - DATOCEANS12) * positif(DATOCEANS12-2014)
        +  max(0,NBMOISI2 * TXMOISRETARD2) * positif(V_ANREV-2017);

TXINRRED22 = (1-positif(V_FLAGR24))* ((max(0,NBMOISI2+NBMOISI) * TXMOISRETARD2 *TXMOISRED) * positif(2017 - DATOCEANS12) * positif(DATOCEANS12-2014)
                                                                      + (NBMOISI2 * TXMOISRETARD2 *TXMOISRED) * positif(V_ANREV - 2017));
TXINRRED24 = positif(V_FLAGR24) * ((max(0,NBMOISI2+NBMOISI) * TXMOISRETARD2 *TXMOISRED2) * positif(2017 - DATOCEANS12) * positif(DATOCEANS12-2014)
                                                                      + (NBMOISI2 * TXMOISRETARD2 *TXMOISRED2) * positif(V_ANREV - 2017));
...
BINRIRIR_PA = BINRIRIR *null(1 - IND_PASSAGE) + BINRIRIR_PA_A* positif(IND_PASSAGE-1);
BINRIRTAXA_PA = BINRIRTAXA *null(1 - IND_PASSAGE) + BINRIRTAXA_PA_A* positif(IND_PASSAGE-1);
BINRIRCAP_PA = BINRIRCAP *null(1 - IND_PASSAGE) + BINRIRCAP_PA_A* positif(IND_PASSAGE-1);
BINRIRCHR_PA =  BINRIRCHR *null(1 - IND_PASSAGE) + BINRIRCHR_PA_A* positif(IND_PASSAGE-1);
BINRPSCS_PA = BINRPSCS *null(1 - IND_PASSAGE) + BINRPSCS_PA_A* positif(IND_PASSAGE-1);
BINRPSRD_PA =  BINRPSRD *null(1 - IND_PASSAGE) + BINRPSRD_PA_A* positif(IND_PASSAGE-1);
BINRPSPS_PA = BINRPSPS *null(1 - IND_PASSAGE) + BINRPSPS_PA_A* positif(IND_PASSAGE-1);
BINRPSCVN_PA = BINRPSCVN *null(1 - IND_PASSAGE) + BINRPSCVN_PA_A* positif(IND_PASSAGE-1);
BINRPSCDIS_PA = BINRPSCDIS *null(1 - IND_PASSAGE) + BINRPSCDIS_PA_A* positif(IND_PASSAGE-1);
BINRPSGLO_PA = BINRPSGLO *null(1 - IND_PASSAGE) + BINRPSGLO_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE1_PA = BINRPSRSE1 *null(1 - IND_PASSAGE) + BINRPSRSE1_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE2_PA = BINRPSRSE2 *null(1 - IND_PASSAGE) + BINRPSRSE2_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE3_PA = BINRPSRSE3 *null(1 - IND_PASSAGE) + BINRPSRSE3_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE4_PA = BINRPSRSE4 *null(1 - IND_PASSAGE) + BINRPSRSE4_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE5_PA = BINRPSRSE5 *null(1 - IND_PASSAGE) + BINRPSRSE5_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE6_PA = BINRPSRSE6 *null(1 - IND_PASSAGE) + BINRPSRSE6_PA_A* positif(IND_PASSAGE-1);
BINRPSC820_PA = BINRPSC820 *null(1 - IND_PASSAGE) + BINRPSC820_PA_A* positif(IND_PASSAGE-1);
BINRPSRSE8_PA =BINRPSRSE8 *null(1 - IND_PASSAGE) + BINRPSRSE8_PA_A* positif(IND_PASSAGE-1);
SOMPASIR_PA =  (arr((max(0,COD8HV+COD8HW-COD8HY)+max(0,COD8IV + COD8IW-COD8IY)+max(0,COD8JV +COD8JW-COD8JY)
            + max(0,COD8KV +COD8KW -COD8KY) + max(0, COD8LV +COD8LW-COD8LY) + max(0,COD8MV +COD8MW-COD8MY))
              * max( 0 ,IRN-IRANT) / BINRIR ) * positif(BINRIR)
                  +
                (max(0,COD8HV+COD8HW-COD8HY)+max(0,COD8IV + COD8IW-COD8IY)+max(0,COD8JV +COD8JW-COD8JY)
              + max(0,COD8KV +COD8KW -COD8KY) + max(0, COD8LV +COD8LW-COD8LY) + max(0,COD8MV +COD8MW-COD8MY)) * null(BINRIR)) *null(1 - IND_PASSAGE) + SOMPASIR_PA_A* positif(IND_PASSAGE-1)
               ;
SOMPASTAXA_PA =  (arr((max(0,COD8HV+COD8HW-COD8HY)+max(0,COD8IV + COD8IW-COD8IY)+max(0,COD8JV +COD8JW-COD8JY)
         + max(0,COD8KV +COD8KW -COD8KY) + max(0, COD8LV +COD8LW-COD8LY) + max(0,COD8MV +COD8MW-COD8MY))
               * max(0,TAXASSUR- min(TAXASSUR+0,max(0,INE-IRB+AVFISCOPTER))+min(0,IRN - IRANT))/BINRIR) * positif(BINRIR)) * null(1 - IND_PASSAGE) + SOMPASTAXA_PA_A* positif(IND_PASSAGE-1) +0
                ;
SOMPASCAP_PA =  (arr((max(0,COD8HV+COD8HW-COD8HY)+max(0,COD8IV + COD8IW-COD8IY)+max(0,COD8JV +COD8JW-COD8JY)
         + max(0,COD8KV +COD8KW -COD8KY) + max(0, COD8LV +COD8LW-COD8LY) + max(0,COD8MV +COD8MW-COD8MY))
               * max(0,IPCAPTAXT- min(IPCAPTAXT+0,max(0,INE-IRB+AVFISCOPTER-TAXASSUR))
                                                   +min(0,IRN - IRANT+TAXASSUR))/BINRIR) * positif(BINRIR) +0)* null(1 - IND_PASSAGE) + SOMPASCAP_PA_A* positif(IND_PASSAGE-1)
              ;
SOMPASCHR_PA =  (arr((max(0,COD8HV+COD8HW-COD8HY)+max(0,COD8IV + COD8IW-COD8IY)+max(0,COD8JV +COD8JW-COD8JY)
              + max(0,COD8KV +COD8KW -COD8KY) + max(0, COD8LV +COD8LW-COD8LY) + max(0,COD8MV +COD8MW-COD8MY))
               * max(0,IHAUTREVT+CHRPVIMP+min(0,IRN - IRANT+TAXASSUR+IPCAPTAXT))/BINRIR) * positif(BINRIR) +0)* null(1 - IND_PASSAGE) + SOMPASCHR_PA_A* positif(IND_PASSAGE-1)
             ;

SOMPASCS_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
               * max(0,CSGC-CICSG-CSGIM) / BINRPS) * positif(BINRPS))* null(1 - IND_PASSAGE) + SOMPASCS_PA_A* positif(IND_PASSAGE-1)
        ;
SOMPASRD_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                   * max(0,RDSC-CIRDS-CRDSIM) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRD_PA_A* positif(IND_PASSAGE-1)
         ;
SOMPASPS_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                * max(0,MPSOL-CIPSOL-PRSPROV) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASPS_PA_A* positif(IND_PASSAGE-1)
           ;
SOMPASCVN_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                    * max(0,CVNN - COD8YT)  / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASCVN_PA_A* positif(IND_PASSAGE-1)
             ;
SOMPASCDIS_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                 * max(0,CDIS - CDISPROV) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASCDIS_PA_A* positif(IND_PASSAGE-1)
             ;
SOMPASGLO_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                * max(0,CGLOA-CIGLOA-COD8YL) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASGLO_PA_A* positif(IND_PASSAGE-1)
         ;
SOMPASC820_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                  * max(0,MCSG820-COD8ZH) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASC820_PA_A* positif(IND_PASSAGE-1)
           ;
SOMPASRSE1_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                   * max(0,RSE1N-CSPROVYD) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE1_PA_A* positif(IND_PASSAGE-1)
             ;
SOMPASRSE2_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                   * max(0,RSE2N-CSPROVRSE2) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE2_PA_A* positif(IND_PASSAGE-1)
               ;
SOMPASRSE3_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                   * max(0,RSE3N-CSPROVYG) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE3_PA_A* positif(IND_PASSAGE-1)
         ;
SOMPASRSE4_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                 * max(0,RSE4N-CSPROVRSE4) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE4_PA_A* positif(IND_PASSAGE-1)
           ;
SOMPASRSE5_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                   * max(0,RSE5N-CSPROVYE)  / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE5_PA_A* positif(IND_PASSAGE-1)
             ;
SOMPASRSE6_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                      * max(0,RSE6N-COD8YQ) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE6_PA_A* positif(IND_PASSAGE-1)
         ;
SOMPASRSE8_PA = (arr((max(0,COD8HX-COD8HZ)+max(0,COD8IX-COD8IZ)+max(0,COD8JX-COD8JZ)+max(0,COD8KX-COD8KZ)+max(0,COD8LX-COD8LZ)+max(0,COD8MX-COD8MZ))
                        * max(0,RSE8N) / BINRPS)* positif(BINRPS)+0)* null(1 - IND_PASSAGE) + SOMPASRSE8_PA_A* positif(IND_PASSAGE-1)
         ;
...
CRDSBR = CRDS_A;
PSOLBR = MPSOL_A;
INRIR_NET1A = INRIR_TL_22_A+ INRIR_TL_24_A+ INRCSG_TL_22_A+ INRCSG_TL_24_A+ INRPSOL_TL_22_A+ INRPSOL_TL_24_A+ INRCRDS_TL_22_A+ INRCRDS_TL_24_A+ INRCDIS_TL_22_A+ INRCDIS_TL_24_A+ INRTAXA_TL_22_A
           + INRTAXA_TL_24_A+ INRCHR_TL_22_A+ INRCHR_TL_24_A+ INRPCAP_TL_22_A+ INRPCAP_TL_24_A+ INRRSE1_TL_22_A+ INRRSE1_TL_24_A+ INRRSE2_TL_22_A+ INRRSE2_TL_24_A+ INRRSE3_TL_22_A+ INRRSE3_TL_24_A
              + INRRSE4_TL_22_A+ INRRSE4_TL_24_A+ INRCVN_TL_22_A+ INRCVN_TL_24_A+ INRGLO_TL_22_A+ INRGLO_TL_24_A+ INRC820_TL_22_A+ INRC820_TL_24_A+ INRIFI_TL_22_A+ INRIFI_TL_24_A+ INRRSE5_TL_22_A
                + INRRSE5_TL_24_A+ INRRSE6_TL_22_A+ INRRSE6_TL_24_A+ INRRSE8_TL_22_A+ INRRSE8_TL_24_A;
...
application :  iliad ;
INRIR_NETA = INRIR_TL_A+ INRCSG_TL_A+ INRPSOL_TL_A+ INRCRDS_TL_A+ INRCDIS_TL_A+ INRTAXA_TL_A+ INRCHR_TL_A
           + INRPCAP_TL_A+ INRRSE1_TL_A+ INRRSE2_TL_A+ INRRSE3_TL_A+ INRRSE4_TL_A+ INRRSE5_TL_A+ INRRSE6_TL_A+ INRRSE8_TL_A+ INRCVN_TL_A+ INRGLO_TL_A+ INRC820_TL_A+ INRIFI_TL_A+ INRRSE6_TL_A+ INRRSE8_TL_A;
