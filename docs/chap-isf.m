...
INDCODIFI = positif(present(COD9AA) + present(COD9AB) + present(COD9AC) + present(COD9AD) + present(COD9BA) + present(COD9BB) + present(COD9CA) 
                    + present(COD9GF) + present(COD9GH) + present(COD9GL) + present(COD9GM) + present(COD9GN)  + present(COD9AE)
...
RDONIFI1 = positif(null(V_IND_TRAIT-4)+positif(COD9ZA)) * (RDONIFI_1) * (1-positif(null(8-CMAJ_ISF)+null(11-CMAJ_ISF)+null(34-CMAJ_ISF)))
          + (max(0,min(RDONIFI_1,max(max(RDONIFI_P,RDONIFI_PA),RDONIFI11731)))*positif(1-COD9ZA)*(1-positif(PREM8_11))) * null(V_IND_TRAIT-5)+0;
...
RDONIFI2 = positif(null(V_IND_TRAIT-4)+positif(COD9ZA)) * (RDONIFI2_1) * (1-positif(null(8-CMAJ_ISF)+null(11-CMAJ_ISF)+null(34-CMAJ_ISF)))
         + (max(0,min(RDONIFI2_1,max(max(RDONIFI2_P,RDONIFI2_PA),RDONIFI21731)))*positif(1-COD9ZA)*(1-positif(PREM8_11)))* null(V_IND_TRAIT-5)+0;
...
NMAJIFI4 =  max (0, MAJO1728IFI2+arr(IFITOT * COPETOIFI2/100)*positif_ou_nul(IFITOT - SEUIL_12)  + (COD8NA * LIM1500 + COD8NB * LIM10000) * (1-positif(MAJOIFI35)) * INDCODIFI
                ) ;
