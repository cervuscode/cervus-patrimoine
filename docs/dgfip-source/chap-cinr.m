...
application :  iliad ;
IRNINMAJO_REF = min(0,(IAN + AVFISCOPTER - IRE - CODCOA + CODZRA) * positif(IAMD1 + 1 + V_ANTREIR - SEUIL_61) - IRANT -max(IR9YI_P,IR9YI_PA));
IRNIN_INRREF = max(0 , min(0 , IAN + AVFISCOPTER - IRE - CODCOA + CODZRA) + max(0 , IAN + AVFISCOPTER - IRE - CODCOA + CODZRA) * positif(IAMD1 + 1 + V_ANTREIR - SEUIL_61) - IRANT -IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1) +max(0,NIRNINBIS_A-NIRNINBIS))
               * positif(min(0 , IAN + AVFISCOPTER - IRE - CODCOA + CODZRA) + max(0 , IAN + AVFISCOPTER - IRE - CODCOA + CODZRA) * positif(IAMD1 + 1 + V_ANTREIR - SEUIL_61) - IRANT-IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1) ) ;
TAXABASE_INRREF = arr(max(TAXASSUR -CODCOU-IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1)-TAXA9YI+ min(0,min( 0, IAN + AVFISCOPTER - IRE) + max( 0, IAN + AVFISCOPTER - IRE )  * positif( IAMD1 + 1 + V_ANTREIR - SEUIL_61)
                                           - IRANT-IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1)- IR9YI ),0)) * positif(IAMD1 + 1 + V_ANTREIR - SEUIL_61);
PCAPBASE_INRREF = arr(max(IPCAPTAXT -CODCOV-IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1)-CAP9YI+ min(0,min( 0, IAN + AVFISCOPTER - IRE ) + max( 0, IAN + AVFISCOPTER - IRE )  * positif( IAMD1 + 1 + V_ANTREIR - SEUIL_61)
                                           - IRANT + TAXASSUR-IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1)- IR9YI-TAXA9YI ),0)) * positif(IAMD1 + 1 + V_ANTREIR - SEUIL_61);
CHRBASE_INRREF = arr(max(IHAUTREVT +CHRPVIMP -CODCOX-CHR9YI*(1-positif(IND_PASSAGE-1))-max(CHR9YI_P,CHR9YI_PA)*positif(IND_PASSAGE-1)-CHR9YI+ min(0,min( 0, IAN + AVFISCOPTER - IRE) + max( 0, IAN + AVFISCOPTER - IRE)  * positif( IAMD1 + 1 + V_ANTREIR - SEUIL_61)
                                             - IRANT + TAXASSUR + IPCAPTAXT-IR9YI*(1-positif(IND_PASSAGE-1))-max(IR9YI_P,IR9YI_PA)*positif(IND_PASSAGE-1)
					     -TAXA9YI*(1-positif(IND_PASSAGE-1))-max(TAXA9YI_P,TAXA9YI_PA)*positif(IND_PASSAGE-1)
					     -CAP9YI*(1-positif(IND_PASSAGE-1))-max(CAP9YI_P,CAP9YI_PA)*positif(IND_PASSAGE-1)) , 0)) * positif(IAMD1 + 1 + V_ANTREIR - SEUIL_61) ;
...
CSG_REFP = max(0,max(max(0, max(0 , CSG - CSGIM - CODCOB)+max(0,NCSBASEBIS_A-NCSBASEBIS)-CS9YP*(1-positif(IND_PASSAGE-1))-max(CS9YP_P,CS9YP_PA)*positif(IND_PASSAGE-1)+NCSBASE)*CSRECINR,((CSBASE_INR_P)*CSREC_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,CSG_PA))));
RDS_REFP = max(0,max(max(0,max(0 , RDSN - CRDSIM - CODCOR)+max(0,NRDBASEBIS_A-NRDBASEBIS)
                                        -RD9YP*(1-positif(IND_PASSAGE-1))-max(RD9YP_P,RD9YP_PA)*positif(IND_PASSAGE-1)+NRDBASE)*CSRECINR,((RDBASE_INR_P)*CSREC_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,CRDS_PA))));
PSOL_REFP = max(0,max(max(0,max(0 , PSOL - PRSPROV - CODCOD)+max(0,NPSOLBASEBIS_A-NPSOLBASEBIS)
                                        -PS9YP*(1-positif(IND_PASSAGE-1))-max(PS9YP_P,PS9YP_PA)*positif(IND_PASSAGE-1)+NPSOLBASE)*CSRECINR,((PSOLBASE_INR_P)*CSREC_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,PSOL_PA))));
CDIS_REFP = max(0,max((max(0,CDIS - CDISPROV  -CODCOF)+NCDISBASE
                                        -CDIS9YP*(1-positif(IND_PASSAGE-1))-max(CDIS9YP_P,CDIS9YP_PA)*positif(IND_PASSAGE-1))*CSRECINR,(CDISBASE_INR_P*CSREC_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,CDIS_PA))));
RSE1_REFP = max(0,max(max(0,RSE1N - CSPROVYD -CODCOT)+NRSE1BASE
                                        -RSE19YP*(1-positif(IND_PASSAGE-1))-max(RSE19YP_P,RSE19YP_PA)*positif(IND_PASSAGE-1),RSE1BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE1_PA)));
RSE2_REFP = max(0,max(max(0, max(0, RSE8TV - CIRSE8TV - CSPROVYF) + max(0, RSE8SA -CIRSE8SA - CSPROVYN) -CODCOL)+NRSE2BASE
                                        -RSE29YP*(1-positif(IND_PASSAGE-1))-max(RSE29YP_P,RSE29YP_PA)*positif(IND_PASSAGE-1),RSE2BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE2_PA)));
RSE3_REFP = max(0,max( max(0,RSE3N - CSPROVYG -CODCOM)-RSE39YP+NRSE3BASE
                                        -RSE39YP*(1-positif(IND_PASSAGE-1))-max(RSE39YP_P,RSE39YP_PA)*positif(IND_PASSAGE-1),RSE3BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE3_PA)));
RSE4_REFP = max(0,max(max(0, RSE4N  - CSPROVYH -CODCOO)-RSE49YP+NRSE4BASE
                                        -RSE49YP*(1-positif(IND_PASSAGE-1))-max(RSE49YP_P,RSE49YP_PA)*positif(IND_PASSAGE-1),RSE4BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE4_PA)));
RSE5_REFP = max(0,max(max(0,RSE5N - CSPROVYE -CODCOJ)-RSE59YP+NRSE5BASE
                                        -RSE59YP*(1-positif(IND_PASSAGE-1))-max(RSE59YP_P,RSE59YP_PA)*positif(IND_PASSAGE-1),RSE5BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE5_PA)));
RSE6_REFP = max(0,max(max(0,RSE6N - COD8YQ -CODCOP)-RSE69YP+NRSE6BASE
                                        -RSE69YP*(1-positif(IND_PASSAGE-1))-max(RSE69YP_P,RSE69YP_PA)*positif(IND_PASSAGE-1),RSE6BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE6_PA)));
RSE8_REFP = max(0,max(max(0,RSE8N - COD8YV -COD8YX -CODCOH)-RSE89YP+NRSE8BASE
                                        -RSE89YP*(1-positif(IND_PASSAGE-1))-max(RSE89YP_P,RSE89YP_PA)*positif(IND_PASSAGE-1),RSE8BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,RSE8_PA)));
CVN_REFP = max(0,max(max(0,CVNN - COD8YT  -CODCOE)-CVN9YP*(1-positif(IND_PASSAGE-1))-max(CVN9YP_P,CVN9YP_PA)*positif(IND_PASSAGE-1)+NCVNBASE,CVNBASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,CVN_PA)));
GLO_REFP = max(0,max(max(0,CGLOA - COD8YL  -CODCOG)-GLO9YP*(1-positif(IND_PASSAGE-1))-max(GLO9YP_P,GLO9YP_PA)*positif(IND_PASSAGE-1)+NGLOBASE,GLOBASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,GLO_PA)));
C820_REFP = max(0,max(max(0,MCSG820 - COD8ZH -CODCOQ)-C8209YP*(1-positif(IND_PASSAGE-1))-max(C8209YP_P,C8209YP_PA)*positif(IND_PASSAGE-1),C820BASE_INR_P*(1-FLAG_PRIM*FLAG_9YT)+max(0,C820_PA)));
...
SOMPASIR_REF = max(SOMPASIR,max(SOMPASIR_REF_A,max(SOMPASIR_REF_P,SOMPASIR_REF_PA)));
SOMPASCS_REF = max(SOMPASCS,max(SOMPASCS_REF_A,max(SOMPASCS_REF_P,SOMPASCS_REF_PA)));
SOMPASRD_REF = max(SOMPASRD,max(SOMPASRD_REF_A,max(SOMPASRD_REF_P,SOMPASRD_REF_PA)));
SOMPASPS_REF = max(SOMPASPS,max(SOMPASPS_REF_A,max(SOMPASPS_REF_P,SOMPASPS_REF_PA)));
SOMPASC820_REF = max(SOMPASC820,max(SOMPASC820_REF_A,max(SOMPASC820_REF_P,SOMPASC820_REF_PA)));
SOMPASCVN_REF = max(SOMPASCVN,max(SOMPASCVN_REF_A,max(SOMPASCVN_REF_P,SOMPASCVN_REF_PA)));
SOMPASGLO_REF = max(SOMPASGLO,max(SOMPASGLO_REF_A,max(SOMPASGLO_REF_P,SOMPASGLO_REF_PA)));
SOMPASRSE1_REF = max(SOMPASRSE1,max(SOMPASRSE1_REF_A,max(SOMPASRSE1_REF_P,SOMPASRSE1_REF_PA)));
SOMPASRSE2_REF = max(SOMPASRSE2,max(SOMPASRSE2_REF_A,max(SOMPASRSE2_REF_P,SOMPASRSE2_REF_PA)));
SOMPASRSE3_REF = max(SOMPASRSE3,max(SOMPASRSE3_REF_A,max(SOMPASRSE3_REF_P,SOMPASRSE3_REF_PA)));
SOMPASRSE4_REF = max(SOMPASRSE4,max(SOMPASRSE4_REF_A,max(SOMPASRSE4_REF_P,SOMPASRSE4_REF_PA)));
SOMPASRSE5_REF = max(SOMPASRSE5,max(SOMPASRSE5_REF_A,max(SOMPASRSE5_REF_P,SOMPASRSE5_REF_PA)));
SOMPASRSE6_REF = max(SOMPASRSE6,max(SOMPASRSE6_REF_A,max(SOMPASRSE6_REF_P,SOMPASRSE6_REF_PA)));
SOMPASRSE8_REF = max(SOMPASRSE8,max(SOMPASRSE8_REF_A,max(SOMPASRSE8_REF_P,SOMPASRSE8_REF_PA)));
SOMPASTAXA_REF = max(SOMPASTAXA,max(SOMPASTAXA_REF_A,max(SOMPASTAXA_REF_P,SOMPASTAXA_REF_PA)));
SOMPASCAP_REF = max(SOMPASCAP,max(SOMPASCAP_REF_A,max(SOMPASCAP_REF_P,SOMPASCAP_REF_PA)));
SOMPASCHR_REF = max(SOMPASCHR,max(SOMPASCHR_REF_A,max(SOMPASCHR_REF_P,SOMPASCHR_REF_PA)));
...
INRTL_RTOTADEF = INRIR_TLDEC_22 +INRCSG_TLDEC_22 +INRCRDS_TLDEC_22 +INRPSOL_TLDEC_22 +INRCDIS_TLDEC_22 +INRTAXA_TLDEC_22 +INRCHR_TLDEC_22 +INRPCAP_TLDEC_22 +INRRSE1_TLDEC_22 +INRRSE2_TLDEC_22
                  +INRRSE3_TLDEC_22 +INRRSE4_TLDEC_22 +INRRSE5_TLDEC_22 +INRRSE6_TLDEC_22 +INRRSE8_TLDEC_22 +INRCVN_TLDEC_22 +INRGLO_TLDEC_22 +INRC820_TLDEC_22
                  +INRIR_TLDEC_24 +INRCSG_TLDEC_24 +INRCRDS_TLDEC_24 +INRPSOL_TLDEC_24 +INRCDIS_TLDEC_24 +INRTAXA_TLDEC_24 +INRCHR_TLDEC_24 +INRPCAP_TLDEC_24
                  +INRRSE1_TLDEC_24 +INRRSE2_TLDEC_24 +INRRSE3_TLDEC_24 +INRRSE4_TLDEC_24 +INRRSE5_TLDEC_24 +INRRSE6_TLDEC_24 +INRRSE8_TLDEC_24 +INRCVN_TLDEC_24
                  +INRGLO_TLDEC_24 +INRC820_TLDEC_24;
INRTL_NRTOTADEF = INRIR_TLDECD +INRCSG_TLDECD +INRCRDS_TLDECD +INRPSOL_TLDECD +INRCDIS_TLDECD +INRTAXA_TLDECD +INRCHR_TLDECD +INRPCAP_TLDECD +INRRSE1_TLDECD +INRRSE2_TLDECD
                    +INRRSE3_TLDECD +INRRSE4_TLDECD +INRRSE5_TLDECD +INRRSE6_TLDECD +INRRSE8_TLDECD +INRCVN_TLDECD +INRGLO_TLDECD +INRC820_TLDECD;
CSGBR2 = CSGBR;
CRDSBR2 = CRDSBR;
PSOLBR2 = PSOLBR;
RETPS2 = INCPS_NET2;
...
RETIR22 = ((INRIR_NTLDEC_22+INRIR_TLDEC_22*TL_IR)
                           + (INRIR_NTL_22_A+INRIR_TL_22_A*TL_IR-arr(DO_INR_IR2*((INRIR_NTL_22_A+INRIR_TL_22_A*TL_IR_A)/(INRIR_NTL_A+INRIR_NTL_22_A+(INRIR_TL_A+INRIR_TL_22_A)*TL_IR_A))))) * positif(RETIR2);
RETIR24 = ((INRIR_NTLDEC_24+INRIR_TLDEC_24*TL_IR)
                           + (INRIR_NTL_24_A+INRIR_TL_24_A*TL_IR-arr(DO_INR_IR2*((INRIR_NTL_24_A+INRIR_TL_24_A*TL_IR_A)/(INRIR_NTL_A+INRIR_NTL_24_A+(INRIR_TL_A+INRIR_TL_24_A)*TL_IR_A))))) * positif(RETIR2);
RETIR2224 = RETIR22+RETIR24;
RETCS22 = ((INRCSG_NTLDEC_22+INRCSG_TLDEC_22*TL_CS)
                           + (INRCSG_NTL_22_A+INRCSG_TL_22_A*TL_CS-arr(DO_INR_CSG2*((INRCSG_NTL_22_A+INRCSG_TL_22_A*TL_CS_A)/(INRCSG_NTL_A+INRCSG_NTL_22_A+(INRCSG_TL_A+INRCSG_TL_22_A)*TL_CS_A))))) * positif(RETCS2);
RETCS24 = ((INRCSG_NTLDEC_24+INRCSG_TLDEC_24*TL_CS)
                           + (INRCSG_NTL_24_A+INRCSG_TL_24_A*TL_CS-arr(DO_INR_CSG2*((INRCSG_NTL_24_A+INRCSG_TL_24_A*TL_CS_A)/(INRCSG_NTL_A+INRCSG_NTL_24_A+(INRCSG_TL_A+INRCSG_TL_24_A)*TL_CS_A))))) * positif(RETCS2);
RETCS2224 = RETCS22+RETCS24;
RETRD22 = ((INRCRDS_NTLDEC_22+INRCRDS_TLDEC_22*TL_RD)
                          + (INRCRDS_NTL_22_A+INRCRDS_TL_22_A*TL_RD-arr(DO_INR_CRDS2*((INRCRDS_NTL_22_A+INRCRDS_TL_22_A*TL_RD_A)/(INRCRDS_NTL_A+INRCRDS_NTL_22_A+(INRCRDS_TL_A+INRCRDS_TL_22_A)*TL_RD_A))))) * positif(RETRD2);
RETRD24 = ((INRCRDS_NTLDEC_24+INRCRDS_TLDEC_24*TL_RD)
                          + (INRCRDS_NTL_24_A+INRCRDS_TL_24_A*TL_RD-arr(DO_INR_CRDS2*((INRCRDS_NTL_24_A+INRCRDS_TL_24_A*TL_RD_A)/(INRCRDS_NTL_A+INRCRDS_NTL_24_A+(INRCRDS_TL_A+INRCRDS_TL_24_A)*TL_RD_A))))) * positif(RETRD2);
RETRD2224 = RETRD22+RETRD24;
RETPSOL22 = ((INRPSOL_NTLDEC_22+INRPSOL_TLDEC_22*TL_PSOL)
                              + (INRPSOL_NTL_22_A+INRPSOL_TL_22_A*TL_PSOL-arr(DO_INR_PSOL2*((INRPSOL_NTL_22_A+INRPSOL_TL_22_A*TL_PSOL_A)/(INRPSOL_NTL_A+INRPSOL_NTL_22_A+(INRPSOL_TL_A+INRPSOL_TL_22_A)*TL_PSOL_A))))) * positif(RETPSOL2);
RETPSOL24 = ((INRPSOL_NTLDEC_24+INRPSOL_TLDEC_24*TL_PSOL)
                              + (INRPSOL_NTL_24_A+INRPSOL_TL_24_A*TL_PSOL-arr(DO_INR_PSOL2*((INRPSOL_NTL_24_A+INRPSOL_TL_24_A*TL_PSOL_A)/(INRPSOL_NTL_A+INRPSOL_NTL_24_A+(INRPSOL_TL_A+INRPSOL_TL_24_A)*TL_PSOL_A))))) * positif(RETPSOL2);
RETPSOL2224 = RETPSOL22+RETPSOL24;
RETCDIS22 = ((INRCDIS_NTLDEC_22+INRCDIS_TLDEC_22*TL_CDIS)
                           + (INRCDIS_NTL_22_A+INRCDIS_TL_22_A*TL_CDIS-arr(DO_INR_CDIS2*((INRCDIS_NTL_22_A+INRCDIS_TL_22_A*TL_CDIS_A)/(INRCDIS_NTL_A+INRCDIS_NTL_22_A+(INRCDIS_TL_A+INRCDIS_TL_22_A)*TL_CDIS_A))))) * positif(RETCDIS2);
RETCDIS24 = ((INRCDIS_NTLDEC_24+INRCDIS_TLDEC_24*TL_CDIS)
                           + (INRCDIS_NTL_24_A+INRCDIS_TL_24_A*TL_CDIS-arr(DO_INR_CDIS2*((INRCDIS_NTL_24_A+INRCDIS_TL_24_A*TL_CDIS_A)/(INRCDIS_NTL_A+INRCDIS_NTL_24_A+(INRCDIS_TL_A+INRCDIS_TL_24_A)*TL_CDIS_A))))) * positif(RETCDIS2);
...
RETCHR22 = ((INRCHR_NTLDEC_22+INRCHR_TLDEC_22*TL_CHR)
                           + (INRCHR_NTL_22_A+INRCHR_TL_22_A*TL_CHR-arr(DO_INR_CHR2*((INRCHR_NTL_22_A+INRCHR_TL_22_A*TL_CHR_A)/(INRCHR_NTL_A+INRCHR_NTL_22_A+(INRCHR_TL_A+INRCHR_TL_22_A)*TL_CHR_A))))) * positif(RETCHR2);
RETCHR24 = ((INRCHR_NTLDEC_24+INRCHR_TLDEC_24*TL_CHR)
                           + (INRCHR_NTL_24_A+INRCHR_TL_24_A*TL_CHR-arr(DO_INR_CHR2*((INRCHR_NTL_24_A+INRCHR_TL_24_A*TL_CHR_A)/(INRCHR_NTL_A+INRCHR_NTL_24_A+(INRCHR_TL_A+INRCHR_TL_24_A)*TL_CHR_A))))) * positif(RETCHR2);
RETCHR2224 = RETCHR22+RETCHR24;
RETPCAP22 = ((INRPCAP_NTLDEC_22+INRPCAP_TLDEC_22*TL_CAP)
                           + (INRPCAP_NTL_22_A+INRPCAP_TL_22_A*TL_CAP-arr(DO_INR_PCAP2*((INRPCAP_NTL_22_A+INRPCAP_TL_22_A*TL_CAP_A)/(INRPCAP_NTL_A+INRPCAP_NTL_22_A+(INRPCAP_TL_A+INRPCAP_TL_22_A)*TL_CAP_A))))) * positif(RETPCAP2);
RETPCAP24 = ((INRPCAP_NTLDEC_24+INRPCAP_TLDEC_24*TL_CAP)
                           + (INRPCAP_NTL_24_A+INRPCAP_TL_24_A*TL_CAP-arr(DO_INR_PCAP2*((INRPCAP_NTL_24_A+INRPCAP_TL_24_A*TL_CAP_A)/(INRPCAP_NTL_A+INRPCAP_NTL_24_A+(INRPCAP_TL_A+INRPCAP_TL_24_A)*TL_CAP_A))))) * positif(RETPCAP2);
RETPCAP2224 = RETPCAP22+RETPCAP24;
RETRSE122 = ((INRRSE1_NTLDEC_22+INRRSE1_TLDEC_22*TL_RSE1)
                            + (INRRSE1_NTL_22_A+INRRSE1_TL_22_A*TL_RSE1-arr(DO_INR_RSE12*((INRRSE1_NTL_22_A+INRRSE1_TL_22_A*TL_RSE1_A)/(INRRSE1_NTL_A+INRRSE1_NTL_22_A+(INRRSE1_TL_A+INRRSE1_TL_22_A)*TL_RSE1_A))))) * positif(RETRSE12);
RETRSE124 = ((INRRSE1_NTLDEC_24+INRRSE1_TLDEC_24*TL_RSE1)
                            + (INRRSE1_NTL_24_A+INRRSE1_TL_24_A*TL_RSE1-arr(DO_INR_RSE12*((INRRSE1_NTL_24_A+INRRSE1_TL_24_A*TL_RSE1_A)/(INRRSE1_NTL_A+INRRSE1_NTL_24_A+(INRRSE1_TL_A+INRRSE1_TL_24_A)*TL_RSE1_A))))) * positif(RETRSE12);
RETRSE12224 = RETRSE122+RETRSE124;
RETRSE222 = ((INRRSE2_NTLDEC_22+INRRSE2_TLDEC_22*TL_RSE2)
                            + (INRRSE2_NTL_22_A+INRRSE2_TL_22_A*TL_RSE2-arr(DO_INR_RSE22*((INRRSE2_NTL_22_A+INRRSE2_TL_22_A*TL_RSE2_A)/(INRRSE2_NTL_A+INRRSE2_NTL_22_A+(INRRSE2_TL_A+INRRSE2_TL_22_A)*TL_RSE2_A))))) * positif(RETRSE22);
RETRSE224 = ((INRRSE2_NTLDEC_24+INRRSE2_TLDEC_24*TL_RSE2)
                            + (INRRSE2_NTL_24_A+INRRSE2_TL_24_A*TL_RSE2-arr(DO_INR_RSE22*((INRRSE2_NTL_24_A+INRRSE2_TL_24_A*TL_RSE2_A)/(INRRSE2_NTL_A+INRRSE2_NTL_24_A+(INRRSE2_TL_A+INRRSE2_TL_24_A)*TL_RSE2_A))))) * positif(RETRSE22);
RETRSE22224 = RETRSE222+RETRSE224;
RETRSE322 = ((INRRSE3_NTLDEC_22+INRRSE3_TLDEC_22*TL_RSE3)
                            + (INRRSE3_NTL_22_A+INRRSE3_TL_22_A*TL_RSE3-arr(DO_INR_RSE32*((INRRSE3_NTL_22_A+INRRSE3_TL_22_A*TL_RSE3_A)/(INRRSE3_NTL_A+INRRSE3_NTL_22_A+(INRRSE3_TL_A+INRRSE3_TL_22_A)*TL_RSE3_A))))) * positif(RETRSE32);
RETRSE324 = ((INRRSE3_NTLDEC_24+INRRSE3_TLDEC_24*TL_RSE3)
                            + (INRRSE3_NTL_24_A+INRRSE3_TL_24_A*TL_RSE3-arr(DO_INR_RSE32*((INRRSE3_NTL_24_A+INRRSE3_TL_24_A*TL_RSE3_A)/(INRRSE3_NTL_A+INRRSE3_NTL_24_A+(INRRSE3_TL_A+INRRSE3_TL_24_A)*TL_RSE3_A))))) * positif(RETRSE32);
RETRSE32224 = RETRSE322+RETRSE324;
RETRSE422 = ((INRRSE4_NTLDEC_22+INRRSE4_TLDEC_22*TL_RSE4)
                            + (INRRSE4_NTL_22_A+INRRSE4_TL_22_A*TL_RSE4-arr(DO_INR_RSE42*((INRRSE4_NTL_22_A+INRRSE4_TL_22_A*TL_RSE4_A)/(INRRSE4_NTL_A+INRRSE4_NTL_22_A+(INRRSE4_TL_A+INRRSE4_TL_22_A)*TL_RSE4_A))))) * positif(RETRSE42);
RETRSE424 = ((INRRSE4_NTLDEC_24+INRRSE4_TLDEC_24*TL_RSE4)
                            + (INRRSE4_NTL_24_A+INRRSE4_TL_24_A*TL_RSE4-arr(DO_INR_RSE42*((INRRSE4_NTL_24_A+INRRSE4_TL_24_A*TL_RSE4_A)/(INRRSE4_NTL_A+INRRSE4_NTL_24_A+(INRRSE4_TL_A+INRRSE4_TL_24_A)*TL_RSE4_A))))) * positif(RETRSE42);
RETRSE42224 = RETRSE422+RETRSE424;
RETRSE522 = ((INRRSE5_NTLDEC_22+INRRSE5_TLDEC_22*TL_RSE5)
                            + (INRRSE5_NTL_22_A+INRRSE5_TL_22_A*TL_RSE5-arr(DO_INR_RSE52*((INRRSE5_NTL_22_A+INRRSE5_TL_22_A*TL_RSE5_A)/(INRRSE5_NTL_A+INRRSE5_NTL_22_A+(INRRSE5_TL_A+INRRSE5_TL_22_A)*TL_RSE5_A))))) * positif(RETRSE52);
RETRSE524 = ((INRRSE5_NTLDEC_24+INRRSE5_TLDEC_24*TL_RSE5)
                            + (INRRSE5_NTL_24_A+INRRSE5_TL_24_A*TL_RSE5-arr(DO_INR_RSE52*((INRRSE5_NTL_24_A+INRRSE5_TL_24_A*TL_RSE5_A)/(INRRSE5_NTL_A+INRRSE5_NTL_24_A+(INRRSE5_TL_A+INRRSE5_TL_24_A)*TL_RSE5_A))))) * positif(RETRSE52);
RETRSE52224 = RETRSE522+RETRSE524;
RETRSE622 = ((INRRSE6_NTLDEC_22+INRRSE6_TLDEC_22*TL_RSE6)
                            + (INRRSE6_NTL_22_A+INRRSE6_TL_22_A*TL_RSE6-arr(DO_INR_RSE62*((INRRSE6_NTL_22_A+INRRSE6_TL_22_A*TL_RSE6_A)/(INRRSE6_NTL_A+INRRSE6_NTL_22_A+(INRRSE6_TL_A+INRRSE6_TL_22_A)*TL_RSE6_A))))) * positif(RETRSE62);
RETRSE624 = ((INRRSE6_NTLDEC_24+INRRSE6_TLDEC_24*TL_RSE6)
                            + (INRRSE6_NTL_24_A+INRRSE6_TL_24_A*TL_RSE6-arr(DO_INR_RSE62*((INRRSE6_NTL_24_A+INRRSE6_TL_24_A*TL_RSE6_A)/(INRRSE6_NTL_A+INRRSE6_NTL_24_A+(INRRSE6_TL_A+INRRSE6_TL_24_A)*TL_RSE6_A))))) * positif(RETRSE62);
RETRSE62224 = RETRSE622 + RETRSE624 ;
RETRSE822 = ((INRRSE8_NTLDEC_22+INRRSE8_TLDEC_22*TL_RSE8)
                              + (INRRSE8_NTL_22_A+INRRSE8_TL_22_A*TL_RSE8-arr(DO_INR_RSE82*((INRRSE8_NTL_22_A+INRRSE8_TL_22_A*TL_RSE8_A)/(INRRSE8_NTL_A+INRRSE8_NTL_22_A+(INRRSE8_TL_A+INRRSE8_TL_22_A)*TL_RSE8_A))))) * positif(RETRSE82);
RETRSE824 = ((INRRSE8_NTLDEC_24+INRRSE8_TLDEC_24*TL_RSE8)
                              + (INRRSE8_NTL_24_A+INRRSE8_TL_24_A*TL_RSE8-arr(DO_INR_RSE82*((INRRSE8_NTL_24_A+INRRSE8_TL_24_A*TL_RSE8_A)/(INRRSE8_NTL_A+INRRSE8_NTL_24_A+(INRRSE8_TL_A+INRRSE8_TL_24_A)*TL_RSE8_A))))) * positif(RETRSE82);
RETRSE82224 = RETRSE822 + RETRSE824 ;
RETCVN22 = ((INRCVN_NTLDEC_22+INRCVN_TLDEC_22*TL_CVN)
                            + INRCVN_NTL_22_A+INRCVN_TL_22_A*TL_CVN-arr(DO_INR_CVN2*((INRCVN_NTL_22_A+INRCVN_TL_22_A*TL_CVN_A)/(INRCVN_NTL_A+INRCVN_NTL_22_A+(INRCVN_TL_A+INRCVN_TL_22_A)*TL_CVN_A)))) * positif(RETCVN2);
RETCVN24 = ((INRCVN_NTLDEC_24+INRCVN_TLDEC_24*TL_CVN)
                            + (INRCVN_NTL_24_A+INRCVN_TL_24_A*TL_CVN-arr(DO_INR_CVN2*((INRCVN_NTL_24_A+INRCVN_TL_24_A*TL_CVN_A)/(INRCVN_NTL_A+INRCVN_NTL_24_A+(INRCVN_TL_A+INRCVN_TL_24_A)*TL_CVN_A))))) * positif(RETCVN2);
RETCVN2224 = RETCVN22+RETCVN24;
RETGLOA22 = ((INRGLO_NTLDEC_22+INRGLO_TLDEC_22*TL_GLO)
                            + INRGLO_NTL_22_A+INRGLO_TL_22_A*TL_GLO-arr(DO_INR_GLO2*((INRGLO_NTL_22_A+INRGLO_TL_22_A*TL_GLO_A)/(INRGLO_NTL_A+INRGLO_NTL_22_A+(INRGLO_TL_A+INRGLO_TL_22_A)*TL_GLO_A)))) * positif(RETGLOA2);
RETGLOA24 = ((INRGLO_NTLDEC_24+INRGLO_TLDEC_24*TL_GLO)
                            + (INRGLO_NTL_24_A+INRGLO_TL_24_A*TL_GLO-arr(DO_INR_GLO2*((INRGLO_NTL_24_A+INRGLO_TL_24_A*TL_GLO_A)/(INRGLO_NTL_A+INRGLO_NTL_24_A+(INRGLO_TL_A+INRGLO_TL_24_A)*TL_GLO_A))))) * positif(RETGLOA2);
RETGLOA2224 = RETGLOA22 + RETGLOA24 ;
RETC82022 = ((INRC820_NTLDEC_22+INRC820_TLDEC_22*TL_MCSG820)
                              + (INRC820_NTL_22_A+INRC820_TL_22_A*TL_MCSG820-arr(DO_INR_C8202*((INRC820_NTL_22_A+INRC820_TL_22_A*TL_MCSG820_A)/(INRC820_NTL_A+INRC820_NTL_22_A+(INRC820_TL_A+INRC820_TL_22_A)*TL_MCSG820_A))))) * positif(RETCSG8202);
RETC82024 = ((INRC820_NTLDEC_24+INRC820_TLDEC_24*TL_MCSG820)
                              + (INRC820_NTL_24_A+INRC820_TL_24_A*TL_MCSG820-arr(DO_INR_C8202*((INRC820_NTL_24_A+INRC820_TL_24_A*TL_MCSG820_A)/(INRC820_NTL_A+INRC820_NTL_24_A+(INRC820_TL_A+INRC820_TL_24_A)*TL_MCSG820_A))))) * positif(RETCSG8202);
...
TINR = TINR2 * positif(INRTL_NRTOTADEF);
TINR_1=(TINR_222 + TINR_242)*positif(INRTL_RTOTADEF);
...
SOMPASIR_PA_A = SOMPASIR_PA;
SOMPASTAXA_PA_A = SOMPASTAXA_PA;
SOMPASCAP_PA_A = SOMPASCAP_PA;
SOMPASCHR_PA_A = SOMPASCHR_PA;
SOMPASCS_PA_A = SOMPASCS_PA;
SOMPASRD_PA_A = SOMPASRD_PA;
SOMPASPS_PA_A = SOMPASPS_PA;
SOMPASCVN_PA_A = SOMPASCVN_PA;
SOMPASCDIS_PA_A = SOMPASCDIS_PA;
SOMPASGLO_PA_A = SOMPASGLO_PA;
SOMPASC820_PA_A = SOMPASC820_PA;
SOMPASRSE1_PA_A = SOMPASRSE1_PA;
SOMPASRSE2_PA_A = SOMPASRSE2_PA;
SOMPASRSE3_PA_A = SOMPASRSE3_PA;
SOMPASRSE4_PA_A = SOMPASRSE4_PA;
SOMPASRSE5_PA_A = SOMPASRSE5_PA;
SOMPASRSE6_PA_A = SOMPASRSE6_PA;
SOMPASRSE8_PA_A = SOMPASRSE8_PA;
BINRIRIR_PA_A = BINRIRIR_PA;
BINRIRTAXA_PA_A = BINRIRTAXA_PA;
BINRIRCAP_PA_A = BINRIRCAP_PA;
BINRIRCHR_PA_A =  BINRIRCHR_PA;
BINRPSCS_PA_A = BINRPSCS_PA;
BINRPSRD_PA_A =  BINRPSRD_PA;
BINRPSPS_PA_A = BINRPSPS_PA;
BINRPSCVN_PA_A = BINRPSCVN_PA;
BINRPSCDIS_PA_A = BINRPSCDIS_PA;
BINRPSGLO_PA_A = BINRPSGLO_PA;
BINRPSRSE1_PA_A = BINRPSRSE1_PA;
BINRPSRSE2_PA_A = BINRPSRSE2_PA;
BINRPSRSE3_PA_A = BINRPSRSE3_PA;
BINRPSRSE4_PA_A = BINRPSRSE4_PA;
BINRPSRSE5_PA_A = BINRPSRSE5_PA;
BINRPSRSE6_PA_A = BINRPSRSE6_PA;
BINRPSC820_PA_A = BINRPSC820_PA;
BINRPSRSE8_PA_A = BINRPSRSE8_PA;
