...
((V_REGCO+0) dans (1,5,6)
   ou (VALREGCO+0) non dans (2,3))
   et
   positif(COD4BK + COD4BL + CODRBK + CODRBT+ 0) = 1
   et
   present(IPBOCH) = 0
...
((V_REGCO+0) dans (1,5,6)
   ou (VALREGCO+0) non dans (2,3))
  et
   positif(COD5AK + COD5BK + COD5CK + 0) = 1
   et
   present(IPBOCH) = 0
...
si
   ((V_REGCO+0) dans (1,5,6)
      ou (VALREGCO+0) non dans (2,3))
   et
   positif(COD5DF + COD5EF + COD5FF + 0) = 1
   et
   present(IPBOCH) = 0
...
si
   ((V_REGCO+0) dans (1,5,6)
      ou (VALREGCO+0) non dans (2,3))
   et
   positif(COD5EY + COD5FY + COD5GY + 0) = 1
   et
   present(IPBOCH) = 0
...
si
  ((V_REGCO+0) dans (1,5,6)
   ou (VALREGCO+0) non dans (2,3))  
   et
   positif(COD5UR + COD5VR + COD5WR + 0) = 1
   et
   present(IPBOCH) = 0
...
si
   ((V_REGCO+0) dans (1,5,6)
      ou (VALREGCO+0) non dans (2,3))
   et
   positif(COD5XJ + COD5YJ + COD5ZJ + 0) = 1
   et
   present(IPBOCH) = 0
...
si
   ((V_REGCO+0) dans (1,5,6)
      ou (VALREGCO+0) non dans (2,3))
   et
   positif(COD5XS + COD5YS + COD5ZS + 0) = 1
   et
   present(IPBOCH) = 0
...
si
  ((V_REGCO) dans(1,3,5,6)
  ou (VALREGCO) dans (3))
  et
 positif(COD8VN + COD8VO) = 1
...
si
   ...
   V_IND_TRAIT > 0
   et
   CSPROVYF + 0 > max(0,(RSE2 + RETRSE2 + NMAJRSE21 + NMAJRSE24 - CIRSE2)) + 0
   et
   (V_GESTPAS+0) < 1
...
si
   ...
   V_IND_TRAIT > 0
   et
   CSPROVYH + 0 > max(0 , RSE8TX + arr(COD8SX*TXTX/100) + arr(COD8QX*TXTX/100) + arr(max(0 , RSE8TX + arr(COD8SX*TXTX/100) + arr(COD8QX*TXTX/100) - CIRSE8TX - CSPROVYH + COD8QX - CICSG8QX) * TXINT/100) - CIRSE8TX - CICSG8QX) + 0
   et
   (V_GESTPAS+0) < 1
...
si
   ...
   V_IND_TRAIT > 0
   et
   COD8YV + 0 > max(0 , ((COD8TH + COD8QH) * TX066/100) + (PRSE8 * positif(COD8TH + COD8QH)) - arr(min(COD8XO , COD8TH + COD8QH) * TX066/100))  + 0
   et
  (V_GESTPAS+0) < 1
...
si
   ...
   positif(COD8XX + 0) = 1
   et
   positif(present(COD2VV) + present(COD2VO)) = 0
   et
   (V_GESTPAS+0) < 1
...
si
  (V_MODUL+0) < 1
   ...
   + present(RCMHAB) + present(COD2TT) + present(COD2VP) + present(REGPRIV) + present(COD2VN) + present(BPVRCM) = 0
   et
   (V_GESTPAS+0) < 1
