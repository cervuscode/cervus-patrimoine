...
/**
 * MODE AUTONOME : ouvert depuis l'accueil, sans client. Aucun accès Pipedrive, aucun
 * pré-remplissage, aucune écriture. Statique.
 */
export default async function AvAutonomePage() {
