...
export default function QRevenus({ data, computed, onChange, onNext, onPrev }: Props) {
  const hasRevenu =
      ...
      <div className="flex flex-col gap-4 p-5 border border-cervus-cream rounded-sm">
        ...
        {parseFloat(data.salaires) > 0 && (
          <div className="flex flex-col gap-3">
            <label className="font-inter text-xs text-cervus-dark/50 uppercase tracking-widest">Abattement</label>
